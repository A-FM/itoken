package pers.ycy.itoken.service.upload.fastdfs;
...
public class FastDFSStorageService implements StorageService, InitializingBean {
	...
	public String upload(byte[] data, String extName) {
		...
		try {
			...
			serviceClose(storageServer,trackerServer,storageClient1);
		}
	}
...
//        System.out.println("deleting ....");
	...
	private void serviceClose(StorageServer storageServer,TrackerServer trackerServer,StorageClient1 storageClient1){
